package com.powerboot.utils.poi;

import com.powerboot.common.annotation.Excel;
import com.powerboot.common.annotation.Excels;
import com.powerboot.common.utils.DateUtils;
import com.powerboot.utils.ServletUtil;
import com.powerboot.utils.StringUtils;
import com.powerboot.utils.reflect.ReflectUtils;
import com.powerboot.utils.text.Convert;
                ...
                for (Map.Entry<Integer, Field> entry : fieldsMap.entrySet())
                {
                    ...
                    if (String.class == fieldType)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                val = DateUtils.parseDate(val.toString(), dateFormat);
                            }
                            else
                            {
    ...
    public Cell addCell(Excel attr, Row row, T vo, Field field, int column)
    {
        ...
        try
        {
            ...
            if (attr.isExport())
            {
                ...
                {
                    cell.setCellValue(DateUtils.parseDate(value.toString(), dateFormat));
                }
