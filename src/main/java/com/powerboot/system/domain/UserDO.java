...
public class UserDO implements Serializable {
    ...
    public String getTeamLeaderStr() {
        return teamLeaderStr;
    }

    public void setTeamLeaderStr(String teamLeaderStr) {
        this.teamLeaderStr = teamLeaderStr;
    }
    ...
    public Integer getLeaderSysId() {
        return leaderSysId;
    }

    public void setLeaderSysId(Integer leaderSysId) {
